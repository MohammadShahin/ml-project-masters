...
class Vectorizer():
    def __init__(self, params=None):
        ...
        if params:
            ...
            self.lemma_vectorizer = CountVectorizer(binary=True, lowercase=True, stop_words='english', encoding='utf-8',
                                                    ngram_range=(1, max_lemma_gram), min_df=lemma_min_df)
            self.pos_vectorizer = CountVectorizer(binary=True, encoding='utf-8', ngram_range=(1, max_pos_gram),
                                                  min_df=pos_min_df)
