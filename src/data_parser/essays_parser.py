...
def _ProcessExampleEssay():
    annotated_sentences = []

    file_txt = open(DATASET_BASE_IN_DIR + 'brat-project-final/brat-project-final/' + 'essay284.txt', 'r',
                    encoding='utf-8')
    # file_txt = open('.\example_essay.txt', 'r', encoding='utf-8')
    # print(file_txt)
    # file_ann = open(DATASET_BASE_IN_DIR + 'brat-project-final/' + essay['ann'], 'r', encoding='utf-8')
    try:
        # reading original text
        ...
        print('Error occured while reading: {}\nError: {}'.format('example', e))

    finally:
        file_txt.close()
        # save all sentences
        print('saving all sentences into example_essay_sentences.json ...')

        with open(DATASET_BASE_OUT_DIR + 'example_essay_sentences.json', 'w', encoding='utf-8') as f:
            json.dump(annotated_sentences, f)


def _ProcessSingleEssay(full_text):
    annotated_sentences = []
    # print('The text is :')
    # print(full_text)
    ...
    return annotated_sentences, topic
