from src.stance_ML.config import *
...
class DataLoadHandler():
    ...
    def __init__(self, test_size=0.2):
        ...
        arg_df = arg_df[['arg-text', 'arg-topic', 'arg-stance', 'train']]
        arg_df['arg-full'] = arg_df['arg-text'] + ' [SEP] ' + arg_df['arg-topic']
        arg_df['arg-stance'] = arg_df['arg-stance'].map({-1: 0, 1: 1})
        ...
        train_labels = train_text['arg-stance']
        test_labels = test_text['arg-stance']
