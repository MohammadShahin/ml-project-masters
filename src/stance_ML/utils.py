...
from src.stance_ML.data_loader import RowSentencesHandler
...
def EvaluateBertSeqCl(model, validation_dataloader):
    ...
    print('eval_accuracy : ', eval_accuracy, ' eval steps ', nb_eval_steps)
    return eval_accuracy / nb_eval_steps
    # Save the model
    # model.save_pretrained('bert_model_double_stage2')
